...
displayName: OPC 评论线索雷达
version: 1.0.6
summary: 找客户、获客、挖销售线索：从抖音、小红书、快手公开评论中识别购买意向和可跟进客户名单。
...
tags: [找客户, 帮我找客户, 获客, 销售线索, 潜在客户, 客户名单, 评论分析, 评论区获客, 小红书获客, 抖音获客, 快手获客]
...
技术 Skill ID 仍为 `ppxc-find-customers`；在 WorkBuddy / SkillHub 的 UI 里应显示为「OPC 评论线索雷达」。
